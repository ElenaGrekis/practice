...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Author.birthyear'
        db.alter_column(u'library_author', 'birthyear', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'Author.birthyear'
        db.alter_column(u'library_author', 'birthyear', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=3))
